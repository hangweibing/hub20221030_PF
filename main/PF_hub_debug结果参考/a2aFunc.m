...
MAX_CRACK_LENGTH = 30;         % 最大合理裂纹长度（mm）
...
%% 数据有效性检查点1：几何形状更新后
upcrack_z_1 = zNewSet(end);
crack_length_1 = upcrack_z_1 - 30;
...
[yNewSet, zNewSet, SPLITTED] = addConstraintNewSatgeFunc(yNewSet, zNewSet, logCstar, gamma);

%% 数据有效性检查点2：边界约束处理后
upcrack_z_2 = zNewSet(end);
crack_length_2 = upcrack_z_2 - 30;
...
%% 数据有效性检查点3：几何正则化后（最终输出）
upcrack_z_3 = zRegSet(end);
crack_length_3 = upcrack_z_3 - 30;
