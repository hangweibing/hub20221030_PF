...
function [yRegSet, zRegSet, SPLITTED, log_theta1_, theta2, theta3, k2, deltaKSet] = ...
         a2aNew(yRegSet, zRegSet, aver_delta_sigma, aver_R, aver_Smax, m_name, curUinput, curAverInput, log_theta1_, theta2, theta3, k2, step, testErrSet, particle_idx)
...
[yRegSet, zRegSet, SPLITTED, log_theta1_, theta2, theta3, k2, deltaKSet] = ...
    a2aFunc(yRegSet, zRegSet, aver_delta_sigma, aver_R, aver_Smax, m_name, ...
