...
%% 功能描述：基于粒子滤波的失效概率计算
%% ===================================================================
function [POF, f_K_vals, K_grid, F_Kc_vals, stats] = calculatePOF(particles_K_max, mu_Kc, std_Kc, varargin)
...
%% 返回统计信息用于主函数显示
%% ===================================================================
stats.K_mean = mean(particles_K_max);
stats.K_std = std(particles_K_max);
stats.K_max = max(particles_K_max);
stats.POF = POF;
stats.num_particles = length(particles_K_max);
