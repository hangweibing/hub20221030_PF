function plot_multi_weight_distribution(xparticles_subset, multi_weights, j, time_val, obs_a, param_obs, true_params)
%% PLOT_MULTI_WEIGHT_DISTRIBUTION 绘制各个维度的似然权重分布对比图
%
% 输入:
%   xparticles_subset - 当前步的粒子状态子集 [N x 5] (z, log_theta1, theta2, theta3, k2)
...
%   true_params       - 真实参数向量 [log_theta1, theta2, theta3, k2]
    ...
    N = size(xparticles_subset, 1);
    labels = {'Crack Length (z)', 'log-theta1', 'theta2', 'theta3', 'k2'};
    units = {'mm', '-', '-', '-', '-'};
